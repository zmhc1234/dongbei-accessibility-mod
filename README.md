...
- 数字键快捷选择只响应剧情中的真实选项；主菜单、故事线、设置、档案等页面不响应数字键。
...
- 回车：确认当前项目。
- Esc：返回或关闭当前页面。
- 数字键 1 到 9：仅在剧情出现选项时直接选择对应剧情选项；主菜单、故事线、设置、档案等页面不触发插件选择。
- D：开关字幕朗读。
- F3：故事线内跳到当前进度节点。
- F5：重复朗读上一条内容。
- F6：停止朗读。
